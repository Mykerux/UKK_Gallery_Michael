...
<head>
  ...
  <title>Daftar User | Gallery Michael</title>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light fixed-top shadow">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link">Login sebagai Admin | {{ Auth::user()->email }}</b></a>
      </li>
    </ul>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Gallery Michael</span>
    </a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            <li class="nav-item menu-open">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="/perizinan" class="nav-link active">
                      <i class=""></i>
                      <p>Perizinan Photo</p>
                    </a>
                  </li>
